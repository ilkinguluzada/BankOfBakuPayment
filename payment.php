...
if(!empty($_POST["packet_id"])){
	...
	$phone = $_POST['phone'];
   	...
   	echo $amount;
		    $params = array();
                    ...
                    $params['description' ] = $packet_name;
 ...
 $decoded= json_decode(file_get_contents("https://epos.az/api/pay2me/pay/?key=$openKey&sum=$control_sum&amount=$amount&phone=$phone&email=$user_email&description=$packet_name&cardType=$cardType&taksit=0&payFormType=DESKTOP&successUrl=$successurl&errorUrl=$failurl"),true);
